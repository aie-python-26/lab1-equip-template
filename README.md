...
- `DECISIONS.md` — разбор дюпа, ответ про сломанную вещь, выбранный вариант из четвёртого пункта и кто им злоупотребит.
...
Автопроверки видят только код. В `DECISIONS.md` они не заглянут и твои тесты не прочитают — это работа преподавателя на защите.
